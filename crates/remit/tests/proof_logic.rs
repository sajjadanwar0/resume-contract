//! Executable cross-check of the Verus proof's computational content
//! (crates/remit/proof/remit_verus.rs). Verifies the lemmas on concrete
//! instances; Verus proves them universally. Passing here is necessary
//! (not sufficient) for the Verus proof and catches logic errors before SMT.
