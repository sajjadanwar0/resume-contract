---- MODULE ResumeContract_TTrace_1784200791 ----
...
_inv ==
    ~(
        ...
        extraResumes = (0)
        /\
        recHist = (<<[dur |-> 1, dec |-> "skip"], [dur |-> 1, dec |-> "reexec"]>>)
        /\
        pcRegress = (FALSE)
        /\
        forkOuts = (<<>>)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ResumeContract_TTrace_1784200791.json", _TETrace)
...
\*
\*trace == IODeserialize("ResumeContract_TTrace_1784200791.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([frontier |-> 1,effects |-> <<1, 0, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE]>>,pc |-> 2,waiting |-> FALSE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<[dur |-> 1, dec |-> "skip"]>>,pcRegress |-> FALSE,forkOuts |-> <<>>,crashes |-> 1]),
    ([frontier |-> 1,effects |-> <<1, 0, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE]>>,pc |-> 1,waiting |-> FALSE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<[dur |-> 1, dec |-> "skip"], [dur |-> 1, dec |-> "reexec"]>>,pcRegress |-> FALSE,forkOuts |-> <<>>,crashes |-> 2])
    >>
----
...
---- CONFIG ResumeContract_TTrace_1784200791 ----
CONSTANTS
    NTasks = 3
    IP = 2
    Values = { va , vb }
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 16 16:19:51 PKT 2026