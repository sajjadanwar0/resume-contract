---- MODULE ResumeContract_TTrace_1784197426 ----
...
_inv ==
    ~(
        ...
        effects = (<<1, 2, 1>>)
        /\
        ckpts = (<<[valid |-> TRUE, idx |-> 1], [valid |-> TRUE, idx |-> 2], [valid |-> TRUE, idx |-> 3]>>)
        /\
        pc = (4)
        /\
        waiting = (FALSE)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ResumeContract_TTrace_1784197426.json", _TETrace)
...
\*
\*trace == IODeserialize("ResumeContract_TTrace_1784197426.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([frontier |-> 1,effects |-> <<1, 0, 0>>,ckpts |-> <<[valid |-> TRUE, idx |-> 1]>>,pc |-> 2,waiting |-> FALSE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<>>,pcRegress |-> FALSE,forkOuts |-> <<>>,crashes |-> 0]),
    ([frontier |-> 1,effects |-> <<1, 0, 0>>,ckpts |-> <<[valid |-> TRUE, idx |-> 1]>>,pc |-> 2,waiting |-> TRUE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<>>,pcRegress |-> FALSE,forkOuts |-> <<>>,crashes |-> 0]),
    ([frontier |-> 2,effects |-> <<1, 1, 0>>,ckpts |-> <<[valid |-> TRUE, idx |-> 1], [valid |-> TRUE, idx |-> 2]>>,pc |-> 3,waiting |-> FALSE,forkVals |-> <<va>>,consumedVal |-> va,extraResumes |-> 0,recHist |-> <<>>,pcRegress |-> FALSE,forkOuts |-> <<va>>,crashes |-> 0]),
    ([frontier |-> 3,effects |-> <<1, 1, 1>>,ckpts |-> <<[valid |-> TRUE, idx |-> 1], [valid |-> TRUE, idx |-> 2], [valid |-> TRUE, idx |-> 3]>>,pc |-> 4,waiting |-> FALSE,forkVals |-> <<va>>,consumedVal |-> va,extraResumes |-> 0,recHist |-> <<>>,pcRegress |-> FALSE,forkOuts |-> <<va>>,crashes |-> 0]),
    ([frontier |-> 3,effects |-> <<1, 1, 1>>,ckpts |-> <<[valid |-> TRUE, idx |-> 1], [valid |-> TRUE, idx |-> 2], [valid |-> TRUE, idx |-> 3]>>,pc |-> 4,waiting |-> FALSE,forkVals |-> <<va, va>>,consumedVal |-> va,extraResumes |-> 0,recHist |-> <<>>,pcRegress |-> FALSE,forkOuts |-> <<va, va>>,crashes |-> 0]),
    ([frontier |-> 3,effects |-> <<1, 2, 1>>,ckpts |-> <<[valid |-> TRUE, idx |-> 1], [valid |-> TRUE, idx |-> 2], [valid |-> TRUE, idx |-> 3]>>,pc |-> 4,waiting |-> FALSE,forkVals |-> <<va, va>>,consumedVal |-> va,extraResumes |-> 1,recHist |-> <<>>,pcRegress |-> FALSE,forkOuts |-> <<va, va>>,crashes |-> 0])
    >>
----
...
---- CONFIG ResumeContract_TTrace_1784197426 ----
CONSTANTS
    NTasks = 3
    IP = 2
    Values = { va , vb }
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 16 15:23:47 PKT 2026