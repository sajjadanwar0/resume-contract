---- MODULE ResumeContract_TTrace_1784197425 ----
...
_inv ==
    ~(
        ...
        effects = (<<1, 1, 1>>)
        /\
        ckpts = (<<[valid |-> TRUE, idx |-> 1], [valid |-> TRUE, idx |-> 2], [valid |-> FALSE, idx |-> 3]>>)
        /\
        pc = (4)
        /\
        waiting = (FALSE)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ResumeContract_TTrace_1784197425.json", _TETrace)
...
\*
\*trace == IODeserialize("ResumeContract_TTrace_1784197425.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([frontier |-> 2,effects |-> <<1, 1, 0>>,ckpts |-> <<[valid |-> TRUE, idx |-> 1], [valid |-> TRUE, idx |-> 2]>>,pc |-> 3,waiting |-> FALSE,forkVals |-> <<vb>>,consumedVal |-> vb,extraResumes |-> 0,recHist |-> <<>>,pcRegress |-> FALSE,forkOuts |-> <<vb>>,crashes |-> 0]),
    ([frontier |-> 3,effects |-> <<1, 1, 1>>,ckpts |-> <<[valid |-> TRUE, idx |-> 1], [valid |-> TRUE, idx |-> 2], [valid |-> FALSE, idx |-> 3]>>,pc |-> 4,waiting |-> FALSE,forkVals |-> <<vb>>,consumedVal |-> vb,extraResumes |-> 0,recHist |-> <<>>,pcRegress |-> FALSE,forkOuts |-> <<vb>>,crashes |-> 0])
    >>
----
...
---- CONFIG ResumeContract_TTrace_1784197425 ----
CONSTANTS
    NTasks = 3
    IP = 2
    Values = { va , vb }
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 16 15:23:46 PKT 2026