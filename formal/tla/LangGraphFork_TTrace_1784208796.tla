---- MODULE LangGraphFork_TTrace_1784208796 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("LangGraphFork_TTrace_1784208796.json", _TETrace)
...
\*
\*trace == IODeserialize("LangGraphFork_TTrace_1784208796.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG LangGraphFork_TTrace_1784208796 ----
CONSTANTS
    Values = { va , vb }
    NoWrite = NoWrite
    MaxInvokes = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 16 18:33:16 PKT 2026