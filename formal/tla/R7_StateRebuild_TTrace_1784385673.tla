---- MODULE R7_StateRebuild_TTrace_1784385673 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("R7_StateRebuild_TTrace_1784385673.json", _TETrace)
...
\*
\*trace == IODeserialize("R7_StateRebuild_TTrace_1784385673.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG R7_StateRebuild_TTrace_1784385673 ----
CONSTANTS
    NTasks = 3
    MaxCrashes = 1
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Jul 18 19:41:14 PKT 2026