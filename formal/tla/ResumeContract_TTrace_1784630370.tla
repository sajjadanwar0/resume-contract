---- MODULE ResumeContract_TTrace_1784630370 ----
...
_inv ==
    ~(
        ...
        effects = (<<1, 2, 0>>)
        /\
        ckpts = (<<[idx |-> 1, valid |-> TRUE], [idx |-> 2, valid |-> TRUE], [idx |-> 2, valid |-> TRUE]>>)
        /\
        pc = (3)
        /\
        waiting = (FALSE)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ResumeContract_TTrace_1784630370.json", _TETrace)
...
\*
\*trace == IODeserialize("ResumeContract_TTrace_1784630370.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([frontier |-> 2,effects |-> <<1, 1, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE], [idx |-> 2, valid |-> TRUE]>>,pc |-> 2,waiting |-> FALSE,forkVals |-> <<va>>,consumedVal |-> va,extraResumes |-> 0,recHist |-> <<[dur |-> 2, dec |-> "reexec"]>>,pcRegress |-> FALSE,forkOuts |-> <<va>>,crashes |-> 1]),
    ([frontier |-> 2,effects |-> <<1, 2, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE], [idx |-> 2, valid |-> TRUE], [idx |-> 2, valid |-> TRUE]>>,pc |-> 3,waiting |-> FALSE,forkVals |-> <<va>>,consumedVal |-> va,extraResumes |-> 0,recHist |-> <<[dur |-> 2, dec |-> "reexec"]>>,pcRegress |-> TRUE,forkOuts |-> <<va>>,crashes |-> 1])
    >>
----
...
---- CONFIG ResumeContract_TTrace_1784630370 ----
CONSTANTS
    NTasks = 3
    IP = 2
    Values = { va , vb }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 21 15:39:31 PKT 2026