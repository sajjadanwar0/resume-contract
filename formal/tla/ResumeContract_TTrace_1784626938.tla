---- MODULE ResumeContract_TTrace_1784626938 ----
...
_inv ==
    ~(
        ...
        extraResumes = (0)
        /\
        recHist = (<<[dur |-> 1, dec |-> "prefixreplay"]>>)
        /\
        pcRegress = (TRUE)
        /\
        forkOuts = (<<>>)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ResumeContract_TTrace_1784626938.json", _TETrace)
...
\*
\*trace == IODeserialize("ResumeContract_TTrace_1784626938.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([frontier |-> 1,effects |-> <<1, 0, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE]>>,pc |-> 1,waiting |-> FALSE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<[dur |-> 1, dec |-> "prefixreplay"]>>,pcRegress |-> FALSE,forkOuts |-> <<>>,crashes |-> 1]),
    ([frontier |-> 1,effects |-> <<2, 0, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE], [idx |-> 1, valid |-> TRUE]>>,pc |-> 2,waiting |-> FALSE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<[dur |-> 1, dec |-> "prefixreplay"]>>,pcRegress |-> TRUE,forkOuts |-> <<>>,crashes |-> 1])
    >>
----
...
---- CONFIG ResumeContract_TTrace_1784626938 ----
CONSTANTS
    NTasks = 3
    IP = 2
    Values = { va , vb }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 21 14:42:18 PKT 2026