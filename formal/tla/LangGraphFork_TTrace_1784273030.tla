---- MODULE LangGraphFork_TTrace_1784273030 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("LangGraphFork_TTrace_1784273030.json", _TETrace)
...
\*
\*trace == IODeserialize("LangGraphFork_TTrace_1784273030.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG LangGraphFork_TTrace_1784273030 ----
CONSTANTS
    Values = { va , vb }
    NoWrite = NoWrite
    MaxInvokes = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Jul 17 12:23:50 PKT 2026