---- MODULE LangGraphFork_TTrace_1784205293 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("LangGraphFork_TTrace_1784205293.json", _TETrace)
...
\*
\*trace == IODeserialize("LangGraphFork_TTrace_1784205293.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG LangGraphFork_TTrace_1784205293 ----
CONSTANTS
    Values = { va , vb }
    NoWrite = NoWrite
    MaxInvokes = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 16 17:34:54 PKT 2026