---- MODULE ResumeContract_TTrace_1784208792 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ResumeContract_TTrace_1784208792.json", _TETrace)
...
\*
\*trace == IODeserialize("ResumeContract_TTrace_1784208792.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([frontier |-> 1,effects |-> <<1, 0, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE]>>,pc |-> 1,waiting |-> FALSE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<[dur |-> 1, dec |-> "replay"]>>,pcRegress |-> FALSE,forkOuts |-> <<>>,crashes |-> 1]),
    ([frontier |-> 1,effects |-> <<2, 0, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE], [idx |-> 1, valid |-> TRUE]>>,pc |-> 2,waiting |-> FALSE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<[dur |-> 1, dec |-> "replay"]>>,pcRegress |-> TRUE,forkOuts |-> <<>>,crashes |-> 1])
    >>
----
...
---- CONFIG ResumeContract_TTrace_1784208792 ----
CONSTANTS
    NTasks = 3
    IP = 2
    Values = { va , vb }
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 16 18:33:13 PKT 2026