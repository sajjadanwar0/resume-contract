---- MODULE R7_StateRebuild_TTrace_1784630381 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("R7_StateRebuild_TTrace_1784630381.json", _TETrace)
...
\*
\*trace == IODeserialize("R7_StateRebuild_TTrace_1784630381.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG R7_StateRebuild_TTrace_1784630381 ----
CONSTANTS
    NTasks = 3
    MaxCrashes = 1
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 21 15:39:41 PKT 2026