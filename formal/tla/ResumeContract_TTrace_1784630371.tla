---- MODULE ResumeContract_TTrace_1784630371 ----
...
_inv ==
    ~(
        ...
        effects = (<<2, 0, 0>>)
        /\
        ckpts = (<<[idx |-> 1, valid |-> TRUE], [idx |-> 1, valid |-> TRUE]>>)
        /\
        pc = (2)
        /\
        waiting = (FALSE)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ResumeContract_TTrace_1784630371.json", _TETrace)
...
\*
\*trace == IODeserialize("ResumeContract_TTrace_1784630371.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([frontier |-> 1,effects |-> <<1, 0, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE]>>,pc |-> 1,waiting |-> FALSE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<[dur |-> 1, dec |-> "reexec"]>>,pcRegress |-> FALSE,forkOuts |-> <<>>,crashes |-> 1]),
    ([frontier |-> 1,effects |-> <<2, 0, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE], [idx |-> 1, valid |-> TRUE]>>,pc |-> 2,waiting |-> FALSE,forkVals |-> <<>>,consumedVal |-> NoVal,extraResumes |-> 0,recHist |-> <<[dur |-> 1, dec |-> "reexec"]>>,pcRegress |-> TRUE,forkOuts |-> <<>>,crashes |-> 1])
    >>
----
...
---- CONFIG ResumeContract_TTrace_1784630371 ----
CONSTANTS
    NTasks = 3
    IP = 2
    Values = { va , vb }
