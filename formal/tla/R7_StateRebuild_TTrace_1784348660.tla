---- MODULE R7_StateRebuild_TTrace_1784348660 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("R7_StateRebuild_TTrace_1784348660.json", _TETrace)
...
\*
\*trace == IODeserialize("R7_StateRebuild_TTrace_1784348660.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([lineage |-> "log",frontier |-> 2,effects |-> <<1, 1, 0>>,pc |-> 3,crashes |-> 0,replaying |-> FALSE]),
    ([lineage |-> "log",frontier |-> 3,effects |-> <<1, 1, 1>>,pc |-> 4,crashes |-> 0,replaying |-> FALSE])
    >>
----
...
---- CONFIG R7_StateRebuild_TTrace_1784348660 ----
CONSTANTS
    NTasks = 3
    MaxCrashes = 1
    FaultStateRebuild = FALSE
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Jul 18 09:24:21 PKT 2026