---- MODULE ResumeContract_TTrace_1784203455 ----
...
_inv ==
    ~(
        ...
        effects = (<<1, 1, 0>>)
        /\
        ckpts = (<<[idx |-> 1, valid |-> TRUE], [idx |-> 2, valid |-> TRUE]>>)
        /\
        pc = (3)
        /\
        waiting = (FALSE)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ResumeContract_TTrace_1784203455.json", _TETrace)
...
\*
\*trace == IODeserialize("ResumeContract_TTrace_1784203455.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([frontier |-> 2,effects |-> <<1, 1, 0>>,ckpts |-> <<[idx |-> 1, valid |-> TRUE], [idx |-> 2, valid |-> TRUE]>>,pc |-> 3,waiting |-> FALSE,forkVals |-> <<va, vb>>,consumedVal |-> va,extraResumes |-> 0,recHist |-> <<>>,pcRegress |-> FALSE,forkOuts |-> <<va, va>>,crashes |-> 0])
    >>
----
...
---- CONFIG ResumeContract_TTrace_1784203455 ----
CONSTANTS
    NTasks = 3
    IP = 2
    Values = { va , vb }
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 16 17:04:16 PKT 2026